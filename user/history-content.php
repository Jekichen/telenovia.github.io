        ...
        <div class="card-body">
            ...
            <?php endif; ?>
                ...
                <div class="alert alert-success text-center">
                    <i class="fa fa-check-circle"></i> Hasil Diagnosa Berhasil Disimpan.
                </div>
            <?php endif; ?>

            <?php if (isset($_GET['pesan'])): ?>
                <?php if ($_GET['pesan'] == 'hapus_sukses'): ?>
                    <div class="alert alert-success text-center"><i class="fa fa-check-circle"></i> Data History Diagnosa Berhasil Dihapus.</div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    if (!$id_akun) {
                        echo "<tr><td colspan='7' class='text-center'>Anda belum login</td></tr>";
                        exit();
                    }

                    $query = "SELECT h.*, p.nama_penyakit AS penyakit_cf, a.nama_lengkap 
                              FROM tbl_hasil h
